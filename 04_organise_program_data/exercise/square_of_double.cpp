// g++ square_of_double.cpp -o square_of_double && ./square_of_double 100
// g++ square_of_double.cpp -o square_of_double && ./square_of_double 999
...
int main(int argc, char *argv[])
{
    ...
    // display
    const string max_int_str = to_string(static_cast<int>(ints[max_int - 1]));
